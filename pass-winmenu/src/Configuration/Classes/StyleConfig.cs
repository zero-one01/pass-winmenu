...
namespace PassWinmenu.Configuration
{
	...
	{
		public LabelStyleConfig Search { get; set; } = new LabelStyleConfig { TextColour = "#FFDDDDDD", BackgroundColour = "#00FFFFFF", BorderWidth = new Thickness(0), BorderColour = "#FF000000" };
		public LabelStyleConfig Options { get; set; } = new LabelStyleConfig { TextColour = "#FFDDDDDD", BackgroundColour = "#00FFFFFF", BorderWidth = new Thickness(0), BorderColour = "#FF000000" };
		public LabelStyleConfig Selection { get; set; } = new LabelStyleConfig { TextColour = "#FFFFFFFF", BackgroundColour = "[accent]", BorderWidth = new Thickness(0), BorderColour = "#FF000000" };
